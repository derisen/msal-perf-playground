        ...
        for (key in cache) {
            switch (key) {
                case "Account":
                    cache[key] = {
                        ...cache[key],
                        [`${crypto.randomUUID()}.cbaf2168-de14-4c72-9d88-f5f05366dbef-login.windows.net-cbaf2168-de14-4c72-9d88-f5f05366dbef`]: dummyAccount
                    };
                    break;
                case "IdToken":
                    cache[key] = {
                        ...cache[key],
                        [`${crypto.randomUUID()}.cbaf2168-de14-4c72-9d88-f5f05366dbef-login.windows.net-idtoken-f2fe5017-b270-41f1-a3c8-0c9dd2f8d05e-cbaf2168-de14-4c72-9d88-f5f05366dbef---`]: dummyIdToken
                    };
                    break;
                case "AccessToken":
                    cache[key] = {
                        ...cache[key],
                        [`${crypto.randomUUID()}.cbaf2168-de14-4c72-9d88-f5f05366dbef-login.windows.net-accesstoken-f2fe5017-b270-41f1-a3c8-0c9dd2f8d05e-cbaf2168-de14-4c72-9d88-f5f05366dbef-openid profile email user.read--`]: dummyAccessToken
                    };
                    break;
                case "RefreshToken":
                    cache[key] = {
                        ...cache[key],
                        [`${crypto.randomUUID()}.cbaf2168-de14-4c72-9d88-f5f05366dbef-login.windows.net-refreshtoken-f2fe5017-b270-41f1-a3c8-0c9dd2f8d05e----`]: dummyRefreshToken
                    };
                    break;
            }
        }
